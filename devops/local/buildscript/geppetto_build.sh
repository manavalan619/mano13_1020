...
DESKTOPCODE='../../../application/client/desktop/mano13_1020'
DESKTOPIMAGENAME='geppettotest/mano13_1020-desktop:1.0'
...
helm install --name mano13_1020 ./helm
if [ $? -eq 0 ]; then
